            ...
            <td>
                <table align="center" width="100%">
                    ...
                    <tr>
                        ...
                        <td><a
                                href="<%=request.getContextPath()%>/?action=edit_phone&phone_id=<%=phone.getId()%>&id=<%=person.getId()%>">Редактировать</a>
                        </td>
                        <td><a
                                href="<%=request.getContextPath()%>/?action=delete_phone&phone_id=<%=phone.getId()%>&id=<%=person.getId()%>">Удалить</a>
                        </td>
                    </tr>
                    <%
                        }
